...
st.write("Lade einen Song hoch, lasse das Genre erkennen und erhalte Vorschläge, die deinem Musikgeschmack entsprechen. 🔥 Bisher können nur Songs aus dem Genre Pop und Rock erkannt werden.")
